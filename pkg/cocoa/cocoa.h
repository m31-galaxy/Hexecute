...
// fullscreen overlay window, and a current OpenGL 4.1 core context, then orders
// the overlay front and hides the system cursor. Returns 0 on success, non-zero
// on failure.
int cocoa_init(void);
